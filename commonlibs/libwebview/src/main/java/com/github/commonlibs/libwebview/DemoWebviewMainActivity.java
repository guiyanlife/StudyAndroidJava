package com.github.commonlibs.libwebview;

import android.os.Bundle;
import android.support.v7.app.AppCompatActivity;
import android.view.View;

import com.github.commonlibs.libwebview.hioscommon.HiosRegister;
...
//                HiosHelper.resolveAd(DemoWebviewMainActivity.this, DemoWebviewMainActivity.this, "hios://.activity.NoHiosMainActivity?act={i}1&sku_id={s}2a&category_id={s}3a");
                HiosHelper.resolveAd(DemoWebviewMainActivity.this, DemoWebviewMainActivity.this, "hios://com.github.commonlibs.libwebview.activity.NoHiosMainActivity?act={i}1&sku_id={s}2a&category_id={s}3a");
            }
        });
        findViewById(R.id.tv21).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HiosHelper.resolveAd(DemoWebviewMainActivity.this, DemoWebviewMainActivity.this, "hios://hs.ac.github.NoHiosMainActivity{act}?act={i}1&sku_id={s}2a&category_id={s}3a");
            }
        });
        ...
        findViewById(R.id.tv61).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO 嵌套webview布局
                HiosHelper.resolveAd(DemoWebviewMainActivity.this, DemoWebviewMainActivity.this, "hios://ad.github.web.page.part{act}");
            }
        });
