...
import com.github.studyandroid.opengl.util.FileUtil;
import com.github.studyandroid.opengl.util.ShaderUtil;
...
public class BitmapTranslucentTriangle {
     ...
     */
    public BitmapTranslucentTriangle(Context context) {
     ...
     */
    public BitmapTranslucentTriangle(Context context, int previewWidth, int previewHeight) {
    ...
    private int getShaderProgram() {
        int shaderProgram;
        String vertexShaderSource = FileUtil.TextFile2String(mContext, R.raw.bmp_tran_vertex_shader);
        String fragmentShaderSource = FileUtil.TextFile2String(mContext, R.raw.bmp_tran_fragment_shader);
    ...
    /**
     * 使用指定Bitmap更新纹理
     * @param bitmap 指定Bitmap图像
     */
    public static void updateTexImage(Bitmap bitmap) {
